...
func TestReferences(t *testing.T) {
	...
	assert.Equal(t, traces, func() ptrace.Traces {
		...
		span1 := spans.AppendEmpty()
		span1.SetName("span1")
		span1.SetTraceID(idutils.UInt64ToTraceID(0, TraceID1))
		span1.SetSpanID(idutils.UInt64ToSpanID(SpanID1))

		span2 := spans.AppendEmpty()
		span2.SetName("span2")
		span2.SetTraceID(idutils.UInt64ToTraceID(0, TraceID1))
		span2.SetSpanID(idutils.UInt64ToSpanID(SpanID2))
		span2.SetParentSpanID(idutils.UInt64ToSpanID(SpanID1))

		span3 := spans.AppendEmpty()
		span3.SetName("span3")
		span3.SetTraceID(idutils.UInt64ToTraceID(0, TraceID1))
		span3.SetSpanID(idutils.UInt64ToSpanID(SpanID3))
		span3.SetParentSpanID(idutils.UInt64ToSpanID(SpanID2))
		link := span3.Links().AppendEmpty()
		link.SetTraceID(idutils.UInt64ToTraceID(0, TraceID1))
		link.SetSpanID(idutils.UInt64ToSpanID(SpanID1))
		link2 := span3.Links().AppendEmpty()
		link2.SetTraceID(idutils.UInt64ToTraceID(0, TraceID2))
...
func TestTranslateFullSimple(t *testing.T) {
	...
	assert.Equal(t, traces, func() ptrace.Traces {
		...
		link.SetTraceID(idutils.UInt64ToTraceID(0, TraceID1))
		link.SetSpanID(idutils.UInt64ToSpanID(SpanID3))
